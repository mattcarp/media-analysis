export const validationRules = {
  ...
  imageStream: {
    codecs: ['mjpeg', 'png', 'gif'],
    codecsMessage: 'Codec name must be Motion JPEG, PNG, or GIF.',
    width: [1000, 2000],
    widthMessage: `Width must be >1000 and <2000 pixels.`,
    height: [800, 1600],
    heightMessage: `Height must be >800 and <1600 pixels.`,
  },
};
